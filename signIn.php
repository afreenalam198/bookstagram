...
<head>
    ...
    <link rel="stylesheet" href="signInSS.css">
...
<body>
    <div class="d-flex justify-content-center align-items-center login-container">
            <form action="" class="login-form text-center" method="post">
                ...
                <input type="submit" class="btn mt-5 rounded-pill btn-lg btn-custom btn-block text-uppercase" value="Log in">
                <br>
...
if (isset($_POST['username']) && ($_POST['password'])) {
    ...
    $query1 = $conn->query("SELECT * FROM user WHERE username = BINARY '" . $username . "' AND password= BINARY '" . $password . "'");
    ...
    if (mysqli_num_rows($query1) == 1) {
        ...
        header("Location: signInDenied.php");
    }
}
