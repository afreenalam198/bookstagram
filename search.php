...
<nav class="navbar navbar-expand-lg navbar-light sticky-top bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarMenu">
            ...
            <form class="search-bar-form" action="search.php" method="post">
                                ...
                                ?>
                                    ...
                                    <div class='card mx-auto mt-5'>
                                        ...
                                        <div class='card-body px-3'>
                                            <h5 class='card-title' style='font-size: 16px;'><a href="index.php"><i id="likeBtn" class='far fa-heart'></i></a>&nbsp; <?php echo $total_likes;?> Likes</h5>
                                            <p> </p>
